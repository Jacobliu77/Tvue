...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/Jacobliu77/Tvue')).toBe(true)
    expect(validURL('http://github.com/Jacobliu77/Tvue')).toBe(true)
    expect(validURL('github.com/Jacobliu77/Tvue')).toBe(false)
  })
  it('validLowerCase', () => {
